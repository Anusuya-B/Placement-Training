...
if($lastInsertId)
{
echo "<script>alert('Company Listed successfully');</script>";
...
<label>Company Name & Location<span style="color:red;">*</span></label>
...
<input class="form-control" type="text" name="isbn" id="isbn" required="required" autocomplete="off" onBlur="checkibnAvailability()"  />
<p class="help-block">Ex: System Analyst | Developer | Call Center Manager | Customer Service |</p>
         <span id="isbn-availability-status" style="font-size:12px;"></span>
</div></div>

<div class="col-md-6">  
 <div class="form-group">
 <label>Salary Package<span style="color:red;">*</span></label>
