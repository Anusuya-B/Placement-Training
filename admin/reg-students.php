...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo htmlentities($result->RegisterNo);?></td>
                                            ...
                                            <td class="center"><?php echo htmlentities($result->Batch);?></td>
                                            <td class="center"><?php echo htmlentities($result->Skill);?></td>
